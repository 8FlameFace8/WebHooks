...
namespace Microsoft.AspNetCore.WebHooks.ApplicationModels
{
    ...
    public class WebHookActionModelPropertyProvider : IApplicationModelProvider
    {
        ...
        private void Apply(ActionModel action)
        {
            ...
            if (receiverName == null)
            {
                // Pass along all IWebHookEventMetadata and IWebHookPingRequestMetadata instances. No need for the
                // IWebHookFilterMetadata collection because WebHookReceiverFilterProvider is always registered.
                eventMetadata = null;
